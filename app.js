...
calc('addition-input1', 'addition-input2', 'addition-button', 'addition-result', add);
...
calc('subtraction-input1', 'subtraction-input2', 'subtraction-button', 'subtraction-result', subtract)
...
calc('multiplication-input1', 'multiplication-input2', 'multiplication-button', 'multiplication-result', multiplication)
...
calc('division-input1', 'division-input2', 'division-button', 'division-result', divide)
